...
class AudioDeviceModuleImpl : public AudioDeviceModuleForTest {
 public:
  ...
  virtual void RegisterDeviceStateCallBack(AudioDeviceState* deviceCallBack) override;
  ...
  void EnableExternalAudioInput(bool enable) override;
  int32_t SendRecordedBuffer(const uint8_t* audio_data,
                                     uint32_t data_len,
                                     int bits_per_sample,
                                     int sample_rate,
 ...
 private:
  ...
  bool external_audio_input_ = false;
};
