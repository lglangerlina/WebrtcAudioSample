...
class AudioDeviceGeneric {
 public:
  ...
  virtual void RegisterDeviceCallback(AudioDeviceState* deviceCallBack) {}
...
// TODO(henrika): add Android support.
  ...
  //gxm gamestreaming
  virtual int setEnableSoftwareAudioProcessing(bool enable);
  virtual bool isEnableSoftwareAudioProcessing();
#endif  // WEBRTC_IOS
