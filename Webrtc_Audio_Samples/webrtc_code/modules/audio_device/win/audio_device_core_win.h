...
class AudioDeviceWindowsCore : public AudioDeviceGeneric {
 public:
  ...
  virtual void RegisterDeviceCallback(AudioDeviceState* deviceCallBack) override;
 ...
 private:
  ...
  CIMMNotificationClient* _notificationClient;
};

  // core audio device detect
class CIMMNotificationClient : public IMMNotificationClient {
  LONG _cRef;

 public:
  CIMMNotificationClient(AudioDeviceState* deviceCallback);
  ~CIMMNotificationClient();

  ULONG STDMETHODCALLTYPE AddRef();
  ULONG STDMETHODCALLTYPE Release();
  void RegisterCallback(AudioDeviceState* deviceCallback);
 ...
 protected:
  ...
  private:
  AudioDeviceState* _deviceCallback;
};
