...
void AudioDeviceModuleImpl::RegisterDeviceStateCallBack(
  ...
  audio_device_->RegisterDeviceCallback(deviceCallback);
...
void AudioDeviceModuleImpl::EnableExternalAudioInput(bool enable) {
  external_audio_input_ = enable;
}
...
//gxm gamestreaming
  int AudioDeviceModuleImpl::setEnableSoftwareAudioProcessing(bool enable){
    RTC_LOG(INFO) << __FUNCTION__;
    int r = audio_device_->setEnableSoftwareAudioProcessing(enable);
    RTC_LOG(INFO) << "output: " << r;
    return r;
  }

  bool AudioDeviceModuleImpl::isEnableSoftwareAudioProcessing(){
        RTC_LOG(INFO) << __FUNCTION__;
        return audio_device_->isEnableSoftwareAudioProcessing();
  }
#endif  // WEBRTC_IOS
