...
class AudioDeviceModule : public rtc::RefCountInterface {
 ...
 public:
  ...
  // for Audio recode callback
  virtual void EnableExternalAudioInput(bool enable) {}
  virtual int32_t SendRecordedBuffer(const uint8_t* audio_data,
    ...
    virtual void RegisterDeviceStateCallBack(AudioDeviceState* deviceCallBack) {}
...
// Only supported on iOS.
  ...
  //gxm gamestreaming
  virtual int setEnableSoftwareAudioProcessing(bool enable) = 0;
  virtual bool isEnableSoftwareAudioProcessing() = 0;
#endif  // WEBRTC_IOS
