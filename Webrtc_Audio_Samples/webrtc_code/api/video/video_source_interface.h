...
class SEISourceInterface {
 public:
  virtual ~SEISourceInterface() = default;

  virtual void AddSEISink(SEISinkInterface* sink) {}

  virtual void RemoveSEISink(SEISinkInterface* sink) {}
};
